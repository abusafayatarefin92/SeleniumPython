...
edge_driver.find_element(By.XPATH,
                         '//*[@id="LoginDiv"]/div/div/a').click()
time.sleep(3)
edge_driver.find_element(By.XPATH,
                         '//*[@id="Email"]').send_keys('centeruser@gmail.com')
time.sleep(1)
edge_driver.find_element(By.XPATH,
                         '//*[@id="Password"]').send_keys('12345')
time.sleep(1)
edge_driver.find_element(By.XPATH,
                         '/html/body/div/div[2]/div/form/div[3]/button').click()
time.sleep(3)
...
# time.sleep(3)
# edge_driver.find_element(By.XPATH,
#                          '//*[@id="kt_body"]/div/div/div/div[2]/div/div[1]/div/div[2]/div/div[1]/div/span/span[1]').click()
# time.sleep(3)
# edge_driver.find_element(By.XPATH, '//*[@id="select2-RegionIdsyphkf1r9kfvzsai161yr-result-u8gj-1"]').click()
# edge_driver.find_element(By.ID,
#                          'select2-RegionIdsyphkf1r9kfvzsai161yr-result-u8gj-1').click()
# time.sleep(3)
